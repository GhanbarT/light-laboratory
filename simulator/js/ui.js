  ...
  allElements.forEach(element => {
    if (element.id && element.id.startsWith('mobile-dropdown-trigger-')) {
      ...
      element.addEventListener('click', (event) => {
        ...
        let originalWidth = $("#mobile-dropdown-tools-root").width();
        let originalMarginLeft = parseInt($("#mobile-dropdown-tools-root").css("margin-left"), 10);
        let originalMarginRight = parseInt($("#mobile-dropdown-tools-root").css("margin-right"), 10);
